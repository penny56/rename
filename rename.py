...
# -*- coding: utf-8 -*-  
'''
20211217, YJ did a minor change.
...
SUFFIX_FILTER =['.jpg', '.png', '.mpg', '.thm', '.bmp', '.jpeg']
...
def generateNewFileName(filename) :
     ...
     if data :
         ...
         try :
             ...
             dateStr = str(t).replace(":", "")[:8] + "_" + str(t)[11:].replace (":", "")
         except :
             pass
     else:
...
if __name__ == "__main__" :
     path = "/Users/mayijie/YijieDoc/Others/TianyiCloud/201801_iphone6_201810"
     scandir(path)